...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Building a strong foundation in software development, data structures, databases, computer networks, and artificial intelligence.",
      "Applying academic concepts through practical projects and full-stack application development.",
      "Continuously strengthening problem-solving, programming, and software engineering skills through hands-on development.",
      "Exploring modern technologies including AI, web development, backend systems, and database-driven applications.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
  ...
  },
  {
    ...
    description: [
      "Developing complete software projects to gain practical experience beyond academic coursework.",
      "Built an AI-powered interview preparation platform using React, FastAPI, MySQL, and multiple AI models.",
      "Developed a graphical password authentication system using React, Node.js, and Express.js.",
      "Focus on building functional applications, integrating APIs, working with databases, and improving real-world development skills.",
    ],
    skills: [
      SkillNames.JS,
      SkillNames.REACT,
